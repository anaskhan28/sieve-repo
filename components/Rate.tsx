  ...
  return (
    <Dialog >
      <DialogTrigger asChild>
        <p className="text-white flex gap-1 justify-center items-center text-sm md:text-base">
          <Star fill={optimisticPlaylist.playlistRating ? "#FAC815" : ""} className='text-yellow-300 cursor-pointer hover:bg-gray-600 h-4 w-4' width={20} height={20} />
